package edu.gatech.ece6258.util.tool;

/**
 *
 * @author Tom Pepels
 * modfidy little bit by Weice for used on RGB purpose
 */
public class FastIca {
    ...
    public static void whitening(double[][] input) {
        // Centering, substract the mean from the signal vectors reduce the complexcity of the calculation
